###########################################################################
## Makefile generated for MATLAB file/project 'ctrainingRoutineKNN2'. 
## 
## Makefile     : ctrainingRoutineKNN2_rtw.mk
## Generated on : Wed Apr 24 12:12:04 2019
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: ./ctrainingRoutineKNN2.a
...
PRODUCT_NAME              = ctrainingRoutineKNN2
MAKEFILE                  = ctrainingRoutineKNN2_rtw.mk
COMPUTER                  = MACI64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/haris/Desktop/Haris2019/EMG/EMG_training_KNN_resources/codegen/lib/ctrainingRoutineKNN2
ARCH                      = maci64
TGT_FCN_LIB               = ISO_C++
...
PRODUCT = ./ctrainingRoutineKNN2.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/haris/Desktop/Haris2019/EMG/EMG_training_KNN_resources -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/CXSparse/Include -I$(START_DIR)/CXSparse/SuiteSparse_config -I$(START_DIR)/CXSparse/CXSparseSupport
...
DEFINES_STANDARD = -DMODEL=ctrainingRoutineKNN2 -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
%.o : /Users/haris/Desktop/Haris2019/EMG/EMG_training_KNN_resources/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /Users/haris/Desktop/Haris2019/EMG/EMG_training_KNN_resources/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
